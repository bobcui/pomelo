 ...
 */
var Processor = function(closeMethod, invalidPackageHandler) {
  EventEmitter.call(this);
  this.closeMethod = closeMethod;
  this.invalidPackageHandler = invalidPackageHandler;
...
Processor.prototype.add = function(socket, data) {
  ...
  var tcpsocket = new TcpSocket(socket, {
    ...
    invalidPackageHandler: this.invalidPackageHandler 
  });
